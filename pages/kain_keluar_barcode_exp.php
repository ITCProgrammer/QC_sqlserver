...
if(isset($_POST['btnBatal'])){
	# Kosongkan Tmp jika datanya sudah dipindah
		...
		echo "</script>";
		echo "<meta http-equiv='refresh' content='0; url=index1.php?p=kain_keluar_barcode_exp&status=Data Sudah DiBatalkan'>";
	}
...
if(isset($_POST['btnSimpan'])){
	...
	*/
	...
	if (count($pesanError)>=1 ){
		...
		//echo "window.open('../cetak/benang_masuk_cetak.php?noNota=$noTransaksi', width=330,height=330,left=100, top=25)";
		echo "</script>";
		echo "<meta http-equiv='refresh' content='0; url=index1.php?p=kain_keluar_barcode_exp&status=Data Sudah Tersimpan'>";
	}
}
