...
<table width="100%" border="0" class="display" id="datatables">
	...
	<tbody>
	<?php 
	  $qry=mysqli_query($con,"SELECT * FROM tbl_lokasi ORDER BY lokasi ASC");
		while($r=mysqli_fetch_array($qry)){
			$qrystk=mysqli_query($con,"SELECT sum(weight) as stok FROM detail_pergerakan_stok WHERE lokasi='".$r['lokasi']."' AND transtatus='1'");
			$rstk=mysqli_fetch_array($qrystk);
	?>  
    <tr align="center">
