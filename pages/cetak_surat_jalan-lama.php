...
<table width="100%" border="0" class="table-list1">
  <tr>
    ...
    <strong> <font size="+1"><center>SURAT JALAN</center></font><font align="center" size="+1">NO.: <?php echo $dr['no_sj']; ?></font><br />
    Tanggal: <?php  echo date("d-F-Y", strtotime($dr['tgl_update']));?>
    <br>
    </strong></td>
...
?></strong></td>
  ...
  <tr>
    <td colspan="3"><div align="center"><strong>BANYAK</strong></div></td>
    <td width="75%" rowspan="2" valign="top"><div align="center"><strong>NAMA BARANG</strong></div>
	<font align="left" size="+1"> <strong><?php echo $dr['no_order'];?></strong></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="+1"><strong>
...
$rjns=mssql_fetch_array($sqljns);
 ...
 ?>
	   ...
	   $sqlitmp=mssql_query("select top 1 ProductId from productpartner where productcode='$itemno' ORDER BY ProductId DESC");
...
$sqlitm1=mssql_query("SELECT description from ProductMaster where ProductNumber='".$itemno."-".$nowarna."'");
 ...
 $rowitm2=mssql_fetch_array($sqlitmp1);
	   ...
	   {
	   echo $rowitm['productcode']."/". htmlentities($rjns['description'],ENT_QUOTES); } 
	   
	   else if($rowitm['productcode']=="" and $rjns['description']!=""){
		   echo $itemno."/". htmlentities($rjns['description'],ENT_QUOTES);
		   } 
	   else if($itemno==""){
			   ...
			   echo $itemno."/". htmlentities($rowitm2['description'],ENT_QUOTES); }else{
			   echo $itemno."/". htmlentities($rowitm1['description'],ENT_QUOTES);
			   }
