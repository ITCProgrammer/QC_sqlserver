...
LEFT JOIN tbl_kite ON tbl_kite.id=tmp_detail_kite.id_kite
WHERE  `packing_list`.`listno`='$_GET[no_sj]'
GROUP BY detail_pergerakan_stok.nokk,tbl_kite.no_lot"; 
	}
...
LEFT JOIN tbl_kite ON tbl_kite.id = tmp_detail_kite.id_kite
WHERE tbl_kite.no_lot='$rowd[no_lot]' and tbl_kite.no_warna='$nowarna' and tbl_kite.no_po='$po' and tbl_kite.nokk='$rowd[nokk]'
