...
<body>
  ...
  <table border="1" align="center" style="font-size:12px">
    <tr align="center">
      ...
      <td rowspan="3"><strong>SN</strong></td>
    ...
    c.warna, c.lebar, c.berat, c.no_item, b.SN, b.lokasi,
    ...
    STRING_AGG(b.lokasi, ', ') WITHIN GROUP (ORDER BY b.lokasi) AS lokasi_gabung
  FROM
  ...
  ORDER BY
    ...
    while ($row = sqlsrv_fetch_array($sql)) {
      ...
      $LocSql = sqlsrv_query($con, "SELECT TOP 1 * FROM tbl_kff_location
WHERE lokasi='" . $row['lokasi'] . "' ");
      $LocWH2 = sqlsrv_fetch_array($LocSql);
      $nwrn = str_replace("'", "''", $row['no_warna']);
      $KFFSql = sqlsrv_query($con, "SELECT TOP 1 * FROM tbl_kff
WHERE no_item='" . $row['no_item'] . "' and nowarnalama='" . $nwrn . "' ");
      $KFF2 = sqlsrv_fetch_array($KFFSql);
      $PriceSql = sqlsrv_query($con, "SELECT TOP 1 * FROM tbl_kff_price
WHERE no_item='" . $row['no_item'] . "' ");
      $Price2 = sqlsrv_fetch_array($PriceSql);
      $PrintSql = sqlsrv_query($con, "SELECT TOP 1 * FROM tbl_kff_print_type
WHERE no_item='" . $row['no_item'] . "' and nowarnalama='" . $nwrn . "' ");
    ...
    <tr>
      ...
      <td colspan="12" align="center">Diperiksa oleh</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="12" align="center">Supervisor</td>
    </tr>
    <tr>
