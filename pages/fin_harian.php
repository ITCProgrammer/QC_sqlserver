                        ...
                        <table id="harian-fin" class="table table-bordered table-striped">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th>Waktu Mulai</th>
                                    <th>Waktu Selesai</th>
                                    <!-- <th>Stop Mesin Mulai</th> -->
                                    <!-- <th>Stop Mesin Mulai Proses Kembali</th> -->
                                    <th>Total</th>
                                    <!-- <th>Kode</th> -->
                                    <th>Keterangan</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $sqlDB2 = "SELECT
                                                ...
                                                WHERE
                                                    q.WORKCENTERCODE = 'P3ST1'
                                                AND
                                                    q.HEADERDATE BETWEEN '$tgl1' AND '$tgl2'
                                                GROUP BY
                                                    q.HEADERLINE, q.PRODUCTIONORDERCODE, op.LONGDESCRIPTION, q.OPERATIONCODE
                                                ORDER BY
                                                    q.HEADERLINE ASC";
                                    ...
                                    while ($rowdb2 = db2_fetch_assoc($stmt)) {
                                        ...
                                        $sql_data = "SELECT 
                                                    ...
                                                    WHERE p2.WORKCENTERCODE = '$mesin' AND p2.PRODUCTIONORDERCODE = '$nokk'";
                                ...
                                ?>
                                <tr>
                                    <td><?= $rowdb2_data['NO_PRODORDER']; ?></td> <!-- NO KK -->
                                    ...
                                    <?php else : ?>
                                        ...
                                        <!-- <td align="center"></td> Stop Mesin Mulai  -->
                                        <!-- <td align="center"></td> Stop Mesin Mulai Proses Kembali -->
                                        <td>=TEXT(O4-P3,"h:mm:ss")</td> <!-- Total -->
                                    <?php endif; ?>
                                    <!-- <td></td> Kode -->
                                    <td></td> <!-- Keterangan -->
                                </tr>
