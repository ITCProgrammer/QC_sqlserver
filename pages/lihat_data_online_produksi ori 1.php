...
<div id="art-page-background-simple-gradient">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="22" align="center"><b>HARIAN KAIN JADI ONLINE <?php echo $_POST['user_name']; ?></b></td>
  </tr>
  <tr>
   <?php $tgl_cetak1= trim($_POST['thn1']."-".$_POST['bln1']."-".$_POST['tgl1']);
   	$tgl_cetak2= trim($_POST['thn2']."-".$_POST['bln2']."-".$_POST['tgl2']);?>
    <td colspan="23"><b>Tanggal : <?php echo  date("d-M-Y", strtotime($tgl_cetak1))." s/d ".date("d-M-Y", strtotime($tgl_cetak2)); ?></b></td>
  </tr>
...
and productprop.productiondate between '$tgl_cetak1 07:00:00' and '$tgl_cetak2 07:00:00' and CAST(TM.dbo.stockmovement.[note] AS VARCHAR(8000)) not like '%IM%'
