...
if(lprn=="Online"){
	window.location.href="index1.php?p=mutasi_kain_masuk_online";
	}
...
<body>
<form name="form1" action="pages/lihat_data_mutasi_kain_masuk_coba.php" method="post" onSubmit="return myFungsi()">
<table width="100%" border="0">
  <tr>
    <th colspan="3" scope="row">&nbsp;</th>
  </tr>
  <tr>
    <th colspan="3" scope="row">Mutasi Kain Masuk COba</th>
  </tr>
  <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
