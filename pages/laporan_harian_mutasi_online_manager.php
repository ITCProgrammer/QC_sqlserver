...
if(mts=="Manual"){
	window.location.href="index1.php?p=laporan_harian_mutasi_manager";
	}
...
<form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="pages/lihat_data_online_mutasi_manager.php">
  <table width="517">
    <tr>
