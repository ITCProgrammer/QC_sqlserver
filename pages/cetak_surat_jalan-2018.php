...
<table width="100%" border="0" class="table-list1">
  <tr>
    ...
    <strong> <font size="+2"><center>NO.: <?php echo $dr['no_sj']; if($_GET['a']=='4'){echo "(B)";}else if($_GET['a']=='8'){echo "(C)";}else if($_GET['a']=='12'){echo "(D)";}else if($_GET['a']=='16'){echo "(E)";}?></center>
    </font>
...
LEFT JOIN detail_pergerakan_stok ON packing_list.listno=detail_pergerakan_stok.refno
WHERE  `packing_list`.`no_sj`='$_GET[no_sj]' ".$tglkirim."
GROUP BY detail_pergerakan_stok.nokk LIMIT $a,4"; 
	}
