...
<form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="pages/lihat_data_mutasi_coba.php">
  <table width="517">
    <tr>
      <td colspan="3"><div align="center"> MUTASI COBA</div><?php 
    ...
    <tr>
      <td height="52"><input type="submit" name="button" id="button" value="Cari Data" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
