...
function ganti(){     
	...
	{ window.location.href="index1.php?p=pengirim-lain-acc"; }
}
</script> 
</head>
...
<body>
<br />
<form id="form1" name="form1" method="post" action="?p=lihat_data_pengiriman_acc">
  <table width="767">
    <tr>
    ...
    <tr>
      <td><a href="#" onClick="window.open('pages/edit_konversi.php','MyWindow','height=200,width=500,top=250,left=500');">Kurs</a></td>
      <td>&nbsp;</td>
      <td><a href="?p=tanda-terima-acc">Tanda Terima Accounting</a></td>
    </tr>
    <tr>
