...
if(lprn=="Manual"){
	window.location.href="form-Packing?p=laporan_harian";
	}
...
<form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="laporan-harian-online">
  <table width="517">
    <tr>
      <td colspan="3"><div align="center">LAPORAN MUTASI ONLINE</div><?php 
