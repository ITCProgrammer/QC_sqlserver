    ...
    <div id="art-main">
      <div class=""></div>
            ...
            <input type="button" class="art-button" onClick="window.location.href='../index_login.php?act=logout'" value="Logout"/>
                            <?php if($_SESSION['status']==0){ ?><input type="button" class="art-button" onClick="window.location.href='../index1.php'" value="Home"/><input type="button" class="art-button" onClick="window.location.href='../index1.php?p=laporan_harian_kain_bs_keluar'" value="Laporan"/><br /><?php } ?>
      <?php $tgl_cetak1=$_POST['awal'];$tgl_cetak2=$_POST['akhir'];?>                 
        <div align="right">&nbsp;<a href="cetak_kain_bs_keluar.php?tgl1=<?php echo $tgl_cetak1; ?>&tgl2=<?php echo $tgl_cetak2; ?>&order=<?php echo $_POST['order'];?>&jlap=<?php echo $_POST['jenislap'];?>">Cetak Ke Excel</a>&nbsp;</div>               
       <table width="100%" align="center" style="font-size:12px"> 
  <tr>
    <td colspan="23" align="center" style="font-size:18px"><b>LAPORAN HARIAN KAIN BS KELUAR <?php if($_POST['jenislap']=="11"){echo " PENGIRIMAN ";}else if($_POST['jenislap']=="12"){ echo " BONGKARAN ";} ?></b> </td>
    </tr>
  <tr>
...
if($tgl_cetak1!="")
  ...
  if($_POST['jenislap']!="semua"){
	  $tran=" AND typetrans='$_POST[jenislap]'";}
	  else{$tran="";}
  ...
  while($row=mysql_fetch_array($sql))
  {
    ...
    <td><a href="#" onClick="window.open('detail-keluar-kain_bs.php?nokk=<?php echo $row['nokk'];?>&ket=<?php echo $row['sisa'];?>','MyWindow','height=400,width=500');"><?php echo $row['nokk'];?></a></td>
