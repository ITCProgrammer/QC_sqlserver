...
<br />
 <form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="pages/persediaan_kain_bs.php">
  <table width="517">
    <tr>
      <td colspan="3"><div align="center">LAPORAN PERSEDIAAN KAIN BS</div>
    ...
    <tr>
      <td>Tanggal Awal</td>
      <td>:</td>
      <td><input name="awal" type="text" id="awal" onclick="if(self.gfPop)gfPop.fPopCalendar(document.form1.awal);return false;" size="10"/>
