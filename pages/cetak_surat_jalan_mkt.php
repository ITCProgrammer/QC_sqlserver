...
GROUP BY SUBSTR(detail_pergerakan_stok.nokk,1,11),tbl_kite.no_lot LIMIT $a,4"; 
	...
	$c=0;
	 while($rowd=mysqli_fetch_array($data)){
		 ...
		 $sqlPR=mysqli_query($con,"SELECT * FROM tbl_pengiriman WHERE tgl_kirim='".$_GET['tgl_kirim']."' AND no_sj='".$_GET['no_sj']."' AND no_item='".$rowd['no_item']."' AND no_po='".$rowd['no_po']."' AND warna='".$rowd['warna']."'");
...
<?php if($rt>1){?>
<p><a href="cetak_surat_jalan_mkt.php?a=4&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>2){?>
<p><a href="cetak_surat_jalan_mkt.php?a=8&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>3){?>
<p><a href="cetak_surat_jalan_mkt.php?a=12&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>4){?>
<p><a href="cetak_surat_jalan_mkt.php?a=16&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>5){?>
<p><a href="cetak_surat_jalan_mkt.php?a=20&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>6){?>
<p><a href="cetak_surat_jalan_mkt.php?a=24&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>7){?>
<p><a href="cetak_surat_jalan_mkt.php?a=28&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>8){?>
<p><a href="cetak_surat_jalan_mkt.php?a=32&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>9){?>
<p><a href="cetak_surat_jalan_mkt.php?a=36&no_sj=<?php echo $_GET['no_sj'];?>&tgl_kirim=<?php echo $_GET['tgl_kirim'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
</body>
</html> 
<script>
