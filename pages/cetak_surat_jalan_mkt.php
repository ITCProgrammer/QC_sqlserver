...
GROUP BY SUBSTR(detail_pergerakan_stok.nokk,1,11),tbl_kite.no_lot LIMIT $a,4"; 
	...
	$c=0;
	 while($rowd=sqlsrv_fetch_array($data)){
		 ...
		 $sqlPR=sqlsrv_query($con,"SELECT * FROM tbl_pengiriman WHERE tgl_kirim='".$_GET['tgl_kirim']."' AND no_sj='".$_GET['no_sj']."' AND no_item='".$rowd['no_item']."' AND no_po='".$rowd['no_po']."' AND warna='".$rowd['warna']."'");
