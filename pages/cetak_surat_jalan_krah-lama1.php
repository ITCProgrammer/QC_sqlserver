...
<table width="100%" border="0" class="table-list1">
  <tr>
    ...
    <td width="12%" rowspan="3"><center><img src="../images/sgs-union-organic-hitam.jpg" alt="" width="120" height="40" /></center></td>
...
<table width="100%" border="0" class="table-list1">
  <tr>
    ...
    <strong> <font size="+2"><center>NO.: <?php echo $dr['no_sj']; if($_GET['a']=='4'){echo "(B)";}else if($_GET['a']=='8'){echo "(C)";}else if($_GET['a']=='12'){echo "(D)";}else if($_GET['a']=='16'){echo "(E)";}?></center></font>
    Tanggal: <?php  echo date("d-F-Y", strtotime($dr['tgl_update']));?><br />No. Order:<font align="center" size="+1"><?php echo $dr['no_order'];?></font><br /></strong></td>
...
echo ", ".$data2['CompanyTitle']." $nama3<br>".$data2['Address']."<br>".$data2['PostalCode']." ".$data2['City']."<br> "."PHONE : ".trim($data2['PhoneNumber'])."<br> FAX : ".$data2['FaxNumber'];}
?></strong></td>
  </tr>
  <tr>
