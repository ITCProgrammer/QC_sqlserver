...
<?php
	...
	$sqllist= mysql_query("SELECT packing_list.*,tbl_kite.pelanggan,tbl_kite.no_po as nopo,detail_pergerakan_stok.satuan from packing_list 
...
WHERE  `packing_list`.`no_sj`='$_GET[no_sj]'  and DATE_FORMAT(tgl_update,'%y')=DATE_FORMAT(NOW(),'%y')
...
<table width="100%" border="0" class="table-list1">
  <tr>
    <td width="82%" rowspan="3">&nbsp;</td>
    <td width="18%"><strong><font size="-4">NO. FORM : 19-11</font></strong></td>
  </tr>
  <tr>
    <td><strong><font size="-43">NO.REVISI : 01</font></strong></td>
  </tr>
  <tr>
    <td height="19"><strong><font size="-4">TGL TERBIT :19 JUNI 2006</font></strong></td>
  </tr>
</table>

<table width="100%" border="0" class="table-list1">
  <tr>
    <td colspan="2" valign="top"><h3>PT INDO TAICHEN<br>TEXTILE INDUSTRY</h3>
    <strong>PO : <font align="center" size="+1.5"><?php echo $dr['no_po']; ?></font></strong></td>
    <td width="26%" valign="top">
    <strong> <font size="+1"><center>SURAT JALAN</center></font><font align="center" size="+1">NO.: <?php echo $dr['no_sj']; if($_GET['a']=='4'){echo "(B)";}else if($_GET['a']=='8'){echo "(C)";}?></font><br />
    Tanggal: <?php  echo date("d-F-Y", strtotime($dr['tgl_update']));?></strong></td>
...
?></strong></td>
  ...
  <tr>
    <td colspan="2"><div align="center"><strong>BANYAK</strong></div></td>
    <td width="75%" rowspan="2" valign="top"><div align="center"><strong>NAMA BARANG</strong></div>
      <strong><font size="+1"><?php echo $dr['no_order'];?></font></strong></td>
    <td width="12%" rowspan="2"><div align="center"><strong>LAIN</strong></div></td>
  </tr>
  <tr>
...
<?php if($rt>1){?>
<p><a href="cetak_surat_jalan_krah.php?a=4&no_sj=<?php echo $_GET['no_sj'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>2){?>
<p><a href="cetak_surat_jalan_krah.php?a=8&no_sj=<?php echo $_GET['no_sj'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>3){?>
<p><a href="cetak_surat_jalan_krah.php?a=12&no_sj=<?php echo $_GET['no_sj'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>4){?>
<p><a href="cetak_surat_jalan_krah.php?a=16&no_sj=<?php echo $_GET['no_sj'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
</body>
</html>
<script>
