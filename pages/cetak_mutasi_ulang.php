...
GROUP BY no_mutasi");
 ...
 $rsift;?> <br> No Mutasi : <?php echo $rowlth['no_mutasi'];?></b></td>
  ...
  <tr align="center" bgcolor="#CCCCCC">
    ...
    <td rowspan="2" bgcolor="#F5F5F5">L/Grm<sup>2</sup></td>
    <td rowspan="2" bgcolor="#F5F5F5">Lot</td>
    <td rowspan="2" bgcolor="#F5F5F5"style="width:0.05in;">Jml. Roll</td>
...
where pergerakan_stok.no_mutasi='$_GET[mutasi]' and tbl_kite.user_packing like'%$usr%'
...
$rowket=mysqli_fetch_array($sqlket);
    ...
    <td align="right"><?php	echo number_format($row['grd_ab'],'2','.',',');?></td>
    ...
    <td align="right"><?php if($rowlth['user_packing']=="KRAH"){echo "<center>-</center>";}else{echo number_format($row['tot_yard'],'2','.',',')." ".$row['satuan']; }?></td>
    <td>
 ...
 <tr >
  ...
  <tr bgcolor="#99FFFF">
    ...
    <td align="right" bgcolor="#FFFFFF"><b><?php echo number_format($totqty,'2','.',',');?></b></td>
    <td align="right" bgcolor="#FFFFFF"><b><?php echo number_format($totqty1,'2','.',',');?></b></td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
