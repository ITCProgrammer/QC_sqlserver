...
and productprop.productiondate between '$tgl_cetak1 07:00:00' and '$tgl_cetak2 14:59:59' and CAST(TM.dbo.stockmovement.[note] AS VARCHAR(8000)) not like '%IM%'
...
left join productprop on productprop.id = stockmovementdetails.productpropid
where stockmovement.wid=22 and stockmovement.transactiontype=4 and stockmovement.transactionstatus=1
and productprop.productiondate between '$tgl_cetak1 15:00:00' and '$tgl_cetak2 22:59:59' and CAST(TM.dbo.stockmovement.[note] AS VARCHAR(8000)) not like '%IM%'
group by stockmovement.ID,stockmovement.PONo,productprop.BatchNo,productprop.PONo,productprop.Width,productprop.WeightPerArea");
...
left join productprop on productprop.id = stockmovementdetails.productpropid
where stockmovement.wid=22 and stockmovement.transactiontype=4 and stockmovement.transactionstatus=1
and productprop.productiondate between '$tgl_cetak1 23:00:00' and '$tgl_cetak2 06:59:59' and CAST(TM.dbo.stockmovement.[note] AS VARCHAR(8000)) not like '%IM%'
group by stockmovement.ID,stockmovement.PONo,productprop.BatchNo,productprop.PONo,productprop.Width,productprop.WeightPerArea");  
