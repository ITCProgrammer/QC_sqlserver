...
<tr style="height:0.1in;"><td valign="top"><center>
  <table width="100%" border="0" cellpadding="0"  class="noborder">
    <tr>
      <td width="24%" rowspan="3"><?php //if($_GET['no_sj']!='') echo '<img src="data:image/png;base64,' . base64_encode($output_img) . '" />'; ?></td>
      <td width="61%" align="left" style="text-align:left;font-size:8px;"><b>PrintDate :
      <?php echo date("d F Y H:i:s", strtotime($dtgl['tgl']));?></b></td>
    ...
    <tr>
      ...
      <td style="text-align:left;font-size:7px;">: 02</td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
      <td style="text-align:left;font-size:7px;">Tgl Terbit</td>
      <td style="text-align:left;font-size:7px;">: 11-02-20</td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0"  class="noborder">
    <tr>
...
E-MAIL: marketing@indotaichen.com Web-site: www.indotaichen.com</font></td>
      <td width="9%" style="text-align:right"><img src="../images/iso-ukas.jpg" width="140" height="100" /></td>
    </tr>
    </table>
  <u>PACKING LIST</u><br>
  No. : <strong><?php echo $_GET['no_sj'];?></strong>
</center>
    <table width="100%" border="0" cellpadding="0"  class="noborder">
      <tr>
...
if($_GET['no_sj']!='')
	{ 
	$sql= "SELECT
	*,GROUP_CONCAT(DISTINCT lokasi) as lokasi_kain
FROM
	packing_list
INNER JOIN detail_pergerakan_stok ON packing_list.listno = detail_pergerakan_stok.refno
INNER JOIN tmp_detail_kite ON detail_pergerakan_stok.id_detail_kj = tmp_detail_kite.id
...
<br />
LOT  &nbsp; &nbsp; &nbsp;:
<?php if($rowd['no_lot']!=''){echo $rowd['no_lot'];}?></td><td width="8%"><font size="+1"><center>
  <font size="+1">
  <?php 
	if($rowd['lokasi_kain']!=""){echo $rowd['lokasi_kain'];}else{echo "N/A";}?>
  </font>
</center></font></td>
  </tr>
      </table>
