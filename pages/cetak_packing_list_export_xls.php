...
header("Content-Disposition: attachment; filename=laplist.xls");
?>
<style>
input{
text-align:center;
...
<?php if($rowd['no_lot']!=''){echo $rowd['no_lot'];}?></td>
  ...
  <tr align="center"  class="tombol" >
    <td width="0" valign="top"><table width="100%" border="0">
      <tr align="center">
        <td width="15%" ><?php if(substr($rowd['no_mc'],0,1)=="R"){echo "ROLL NO";}else{echo "BALES NO";}?></td>
        <td>MEAS</td>
        <td>KGS</td>
      ...
      while($row1=mysql_fetch_array($sql1))
  {
      ...
      <tr>
        ...
        <td align="center" ><?php if($row1['ukuran']!=""){echo $row1['ukuran'];}else{echo"-";}?></td>
      ...
      while($row2=mysql_fetch_array($sql2))
  {
      ...
      <tr>
        ...
        <td align="center" ><?php if($row2['ukuran']!=""){echo $row2['ukuran'];}else{echo"-";}?></td>
      ...
      while($row3=mysql_fetch_array($sql3))
  {
      ...
      <tr>
        ...
        <td align="center"><?php if($row3['ukuran']!=""){echo $row3['ukuran'];}else{echo"-";}?></td>
