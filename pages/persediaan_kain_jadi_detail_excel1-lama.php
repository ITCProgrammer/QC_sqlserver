...
<?php 
  ...
  while($row=mysql_fetch_array($sql))
  {
	...
	SUM(if(b.grade='C' or b.grade='', 1, 0)) as rol_c,
...
GROUP BY b.nokk");
 ...
 <tr>
  ...
  <tr>
    <td colspan="29"><b>( Roll : <?php echo  number_format($totrol);  ?> ) (GRADE A+B: <?php echo  number_format($totab,'2','.',',');  ?> Kg, Roll: <?php echo  number_format($rolab);  ?>)  (GRADE C: <?php echo  number_format($tota,'2','.',',');  ?> Kg, Roll: <?php echo  number_format($rolac);  ?>) (TOTAL : <?php echo  number_format($totab+$tota,'2','.',',');  ?> Kg) </b></td>
    </tr>
  </table>
</body>