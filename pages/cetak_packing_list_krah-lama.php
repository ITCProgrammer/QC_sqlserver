...
.noborder tr td .table-list1 .tombol td table tr td {
	font-size: 10px;
}
-->
</style>
...
FROM
	packing_list
INNER JOIN detail_pergerakan_stok ON packing_list.listno = detail_pergerakan_stok.refno
INNER JOIN tmp_detail_kite ON detail_pergerakan_stok.id_detail_kj = tmp_detail_kite.id
...
<tr style="height:0.1in;"><td valign="top"><center>
  <table width="100%" border="0" cellpadding="0"  class="noborder">
    <tr>
      ...
      <td width="8%" style="text-align:left;font-size:7px;">:17-07</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td align="center">&nbsp;</td>
      <td style="text-align:left;font-size:7px;">No Revisi</td>
      <td style="text-align:left;font-size:7px;">: 00</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td align="center">&nbsp;</td>
      <td style="text-align:left;font-size:7px;">Tgl Terbit</td>
      <td style="text-align:left;font-size:7px;">: 23 Mei 2006</td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0"  class="noborder">
    <tr>
      ...
      <td width="83%" align="center"><font size="5px"><strong>PT. INDO TAICHEN TEXTILE INDUSTRY</strong></font><br />
        KNITTING, DYEING, FINISHING<br />
        <font size="1px"><strong>OFFICE/FACTORY</strong> : JL. RAYA SERANG KM. 3 (KALI SABI) DESA UWUNG JAYA, CIBODAS <br />TANGERANG 15138 KOTA - TANGERANG P.O.BOX 487 - BANTEN - INDONESIA<br />
        <strong>PHONE</strong> : ( 021 ) - 5520920(HUNTING), FAX : ( 021 ) - 5523763,55790329,5520035</font></td>
      <td width="9%" style="text-align:right"><img src="../images/cart.jpg" width="140" height="80" /></td>
    </tr>
    </table><br />
  <u>PACKING LIST</u></center>
    <table width="100%" border="0" cellpadding="0"  class="noborder">
      <tr>
...
$rjns=mssql_fetch_array($sqljns);
	...
	$sqla=mysql_query("SELECT count(no_lot)as roll,sum(detail_pergerakan_stok.weight) as berat,sum(tmp_detail_kite.netto) as panjang,detail_pergerakan_stok.satuan FROM packing_list 
...
order by detail_pergerakan_stok.id asc LIMIT $lakhr,$batas");
	?>
    FABRIC : <?php echo $rowd['no_item']." ".$rowd['jenis_kain']."&nbsp; &nbsp; &nbsp; &nbsp;".number_format($rowd['lebar'],'2',',','.')."'' X ".number_format($rowd['berat'],'2',',','.')."''";?><br />
...
<?php if($rowd['no_lot']!=''){echo $rowd['no_lot'];}?></td>
      ...
      while($row1=mysql_fetch_array($sql1))
  {
	  ...
	  ?>
      <tr>
        <td align="center"><?php if($row1['no_roll']!=''){echo $row1['no_roll'];}else{echo $rsvr['rollno'];}?></td>
        <td ><?php echo $row1['SN'];?></td>
        <td align="right"><?php echo $row1['ukuran'];?></td>
        <td align="right"><?php echo number_format($row1['weight'],'2','.',',');?></td>
        <td align="right"><?php echo  $row1['netto']; ?></td>
      </tr>
       <?php
	  $totbruto=$totbruto+$row1['weight'];
	  $totyrd=$totyrd+$row1['netto'];
	  $totroll=$totroll+1;
	  }  ?>
  </table></td>
  ...
  <tr class='tombol'>
    ...
    <td  align="right"><strong><?php echo $jmldata['panjang']." ".$jmldata['satuan'];?></strong></td>
    </tr>
...
<table width="100%" border="0" cellpadding="0" class="table-list1">
  <tr style="text-align:center">
    ...
    <td>PCS : <strong><?php echo $totyrd;?></strong></td>
  </tr>
  <tr style="text-align:center">
    <td colspan="2">&nbsp;</td>
    <td>Dibuat Oleh</td>
  ...
  <tr>
    ...
    <td style="text-align:center"><?php echo Indonesia2Tgl($dtgl['tgl']);?></td>
    <td style="text-align:center"><?php echo Indonesia2Tgl($dtgl['tgl']);?></td>
  </tr>
