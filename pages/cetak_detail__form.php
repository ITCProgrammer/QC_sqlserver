...
ORDER BY detail_kite.id ASC limit 40,20");
  ...
  $no=1;
  ?>
  <table width="100%"  align="center" border="0" class="table-list">
    <tr><td width="19%" valign="top">
  <table width="30" border="0" class="table-list">
  <tr align="center" >
...
<?php 
 ...
 <table width="50%" border="0" class="table-list" align="left"><tr>
    <td width="75">&nbsp;</td>
    <td width="75">&nbsp;</td>
    <td width="75">&nbsp;</td>
    <td width="75">&nbsp;</td>
 ...
 <table width="32%" align="left" border="0" class="table-list" ><tr>
 ...
 <table width="10%" border="0" class="table-list" align="left"><tr>
