...
<table width="100%" border="1">
  <tr>
    <td colspan="25" align="center"><h1><b>LAPORAN HARIAN KAIN JADI <?php if($_GET['jlap']=="Pengiriman"){echo " PENGIRIMAN ";}else if($_GET['jlap']=="Bongkaran"){ echo " BONGKARAN ";}else if($_GET['jlap']=="Ganti Stiker"){ echo " GANTI STIKER ";}else if($_GET['jlap']=="Revisi Stiker"){ echo " REVISI STIKER ";} ?></b></h1></td>
    </tr>
  <tr>
 <td colspan="25">Shift :
