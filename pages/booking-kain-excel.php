...
header("Content-Disposition: attachment; filename=booking-kain.xls");
?>
<?php
...
<table width="100%" align="center" style="font-size:11px" border="1">
  <tr align="center" >
    ...
    <td width="34" rowspan="3">UNIT</td>
    <td width="34" rowspan="3">LOKASI</td>
    <td width="59" rowspan="3">FOC</td>
    ...
    <td width="74" rowspan="3">Status Warna</td>
  </tr>
  <tr align="center" >
