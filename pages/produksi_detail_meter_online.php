...
and productprop.productiondate between '$_GET[tgl1] 07:00:00' and '$_GET[tgl2] 07:00:00' and productprop.batchno='$_GET[id]'");
...
if(yrd=="yard"){
	...
	return false;
       ...
       <div align="center"><b>PRODUKSI DETAIL ONLINE </b> </div><div><b>Tanggal : <?php echo $_GET['tgl1']." s/d ".$_GET['tgl2']; ?> <br>
