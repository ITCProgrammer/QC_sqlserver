...
if(mts=="Online"){
	window.location.href="index1.php?p=laporan_harian_mutasi_online_manager";
	}
...
<form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="pages/lihat_data_mutasi_manager.php">
  <table width="517">
    <tr>
    ...
    <tr>
      <td>Group </td>
      <td>:</td>
      <td><select name="user_name" id="sift">
