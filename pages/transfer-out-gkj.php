...
<form  action="pages/simpan-detail-out-gkj.php" method="POST" name="form1" id="form1"  onSubmit="return myFungsi();">
 <div align="center">
  <h1>TRANSFET OUT GUDANG</h1></div><hr />
 <fieldset>
	...
	*/
    ...
    <tr>
      ...
      <td width="252"><label for="partners"></label>
        <select name="partners" id="partners " onchange="window.location='?p=transfer-out-gkj&kkno=<?php echo $_GET['kkno']; ?>&ke='+this.value">
