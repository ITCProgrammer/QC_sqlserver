    ...
    <div id="art-main">
      <div class=""></div>
            ...
            <input type="button" class="art-button" onClick="window.location.href='../index_login.php?act=logout'" value="Logout"/>
                   ...
                   <center>
                   <b>LAPORAN PERSEDIAAN KAIN JADI BS</b>
                   </center>    
...
mysql_select_db("db_qc")or die("Gagal Koneksi");
  ...
  $sql=mysql_query(" SELECT
	...
	AND (a.fromtoid = 'QC BS') AND not ISNULL(b.transtatus) AND b.transtatus='1' ".$where8.$where7.$where6.$where5.$where4.$where3.$where.$where1." 
	GROUP BY
