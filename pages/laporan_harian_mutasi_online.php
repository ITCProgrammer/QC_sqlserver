...
if(mts=="Manual"){
	window.location.href="form-Packing?p=laporan_harian_mutasi";
	}
...
<form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="pages/lihat_data_online_mutasi.php">
  <table width="517">
    <tr>
      <td colspan="3"><div align="center">MUTASI ONLINE</div><?php 
	  $user_name=$_SESSION['username'];
	  date_default_timezone_set('Asia/Jakarta');
	$tgl=date("Y-M-d h:i:s A");
	  echo $tgl;?>
      <br />GROUP SHIFT: <strong><?php echo $_SESSION['username']; ?></strong></td>
    </tr>
    <tr>
