...
function docno(){
	...
	$con=sqlsrv_connect("10.0.0.10","dit","4dm1n","db_qc");
		...
		$format = date("ymd")."3";
		$sql=sqlsrv_query($con,"SELECT documentno FROM pergerakan_stok WHERE substr(documentno,1,7) like '%".$format."%'
...
<fieldset>
  ...
  <div class="rol">
    <table width="" border="0" cellpadding="1" cellspacing="1">
      ...
      <?php
	//tambahan
	$data=sqlsrv_query($con,"SELECT a.*,b.no_order,b.no_po,b.pelanggan,b.no_lot,b.warna FROM tmp_detail_pergerakan_stok a
