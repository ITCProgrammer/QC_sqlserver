...
$sqlsimpan=sqlsrv_query($con,"INSERT INTO `tbl_log_surat_jalan` SET 
`userid`='PPC', 
`ipaddress`='$ipadd', 
`no_sj`='".$_GET['nolist']."',
`aksi`='hapus', 
...
`tgl_update`=now()
");
$cari=sqlsrv_query($con,"update detail_pergerakan_stok set refno=null WHERE id='".$_GET['id']."' limit 1");
if($cari >0){ 
