...
<body>
    <div id="art-main">
      <input type="button" class="art-button" onClick="window.location.href='../index_login.php?act=logout'" value="Logout"/>
           ...
           <form  action="cetak/cetak_online_mutasi.php" method="POST" name="form1">            
...
and stockmovement.dated between '$tgl_cetak1' and '$tgl_cetak2' and CAST(TM.dbo.stockmovement.[note] AS VARCHAR(8000)) $bgn like '%IM%'
...
group by stockmovementdetails.Weight,productprop.BatchNo");
  ...
  $n++;
   ?></td>
    ...
    <td>
	 <a href="../index1.php?p=mutasi_detail_online&id=<?php echo $row['batchno'];?>&tgl1=<?php echo $tgl_cetak1; ?>&tgl2=<?php echo $tgl_cetak2; ?>&sift=<?php echo $_POST['sift'];?>&bagian=<?php echo $_POST['user_name']; ?>"><?php echo $row['batchno']; ?></a>
