...
<table width="100%" border="1">
  ...
  <tr>
 <td colspan="21"><b>Tanggal : <?php echo  date("d-M-Y", strtotime($_GET['tgl1']))." s/d ".date("d-M-Y", strtotime($_GET['tgl2'])); ?> 
 </b></td>
 </tr>
...
and sisa='$row[sisa]' GROUP BY pergerakan_stok.id
ORDER BY pergerakan_stok.id ASC");
...
$rtmpt=mysql_fetch_array($stmpt);
 ...
 <tr>
  ...
  <tr >
    <td height="26" colspan="3" >Tanggal</td>
    <td colspan="9" align="center">&nbsp;</td>
    <td colspan="9" align="center">&nbsp;</td>
  </tr>
  <tr >
