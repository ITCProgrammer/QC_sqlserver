...
<table width="100%" border="0" class="table-list1">
  <tr>
    ...
    <td width="22%"><div align="center"><strong>Pengemudi</strong></div></td>
    <td width="21%"><div align="center"><strong>Disetujui Oleh</strong></div></td>
    <td width="23%"><div align="center"><strong>Diterima Pada</strong></div></td>
  </tr>
  <tr align="center">
    <td width="15%">&nbsp;</td>
    <td width="19%"><img src="ttd/aris-removebg.png" width="123" height="60" alt=""/></td>
    <td><br /><br /><br /><br /><br /><br /></td>
    <td><img src="ttd/putri-removebg.png" width="117" height="60" alt=""/></td>
    <td valign="top"><div align="left"><strong>Tanggal</strong></div></td>
  </tr>
  <tr>
