...
<body>
    <div id="art-main">
      <div class=""></div>
            ...
            <input type="button" class="art-button" onClick="window.location.href='../index_login.php?act=logout'" value="Logout"/>
                            <?php if($_SESSION['status']==0){ ?><input type="button" class="art-button" onClick="window.location.href='../index1.php'" value="Home"/><input type="button" class="art-button" onClick="window.location.href='../index1.php?p=laporan_harian_kain_bs'" value="Laporan"/><br /><?php } ?>
  ...
  <input name="tgl1" type="hidden" value="<?php echo $tgl_cetak2;?>">  
    <td colspan="20"><div align="right">&nbsp;<a href="cetak_kain_bs_masuk.php?tgl1=<?php echo $tgl_cetak1; ?>&tgl2=<?php echo $tgl_cetak2; ?>&order=<?php echo $_POST['order'];?>&jlap=<?php echo $_POST['jenislap'];?>">Cetak Ke Excel</a>&nbsp;</div>
      <b>Tanggal: <?php echo  $tgl_cetak1;  ?> s/d <?php echo  $tgl_cetak2;  ?></b></td>
    </tr>
  ...
  $sql=mysql_query("SELECT
	...
	SUM(if(b.grade='A' or b.grade='' , 1, 0)) as jml_a,
	SUM(if(b.grade='B', 1, 0)) as jml_b,
  ...
  while($row=mysql_fetch_array($sql))
  {
	...
	?></td>
    <td align="right"><?php 
	$grab=number_format($row['grd_a'],'2','.',',');echo $grab;?></td>
    <td align="right"><?php 
	$grab=number_format($row['grd_b'],'2','.',',');echo $grab;?></td>
    <td align="right"><?php 
