...
<title>MUTASI KAIN JADI</title>
<script>
   
          function ganti()
{     var mts= document.forms['form2']['mts'].value;  
if(mts=="Manual"){
	window.location.href="form-Packing?p=laporan_harian_mutasi_kain";
	}
...
<form name="form2">
      ...
      <br />
<form id="form1" name="form1" method="post" action="laporan-harian-mutasi-online">
  <table width="517">
    <tr>
