...
<body><?php
		...
		ORDER BY documentno DESC ") or die("Gagal");
		...
		if (isset($_POST['btnTambah'])) {
			...
			$cekSql2 = "SELECT * FROM db_qc.etail_pergerakan_stok WHERE SN='$Barcode' AND transtatus='2'";
			...
			if ((sqlsrv_num_rows($cekQry) >= 1) or (sqlsrv_num_rows($cekQry2) >= 1)) {
				...
				$mySql = "SELECT * FROM db_qc.detail_pergerakan_stok WHERE SN='$Barcode' AND transtatus='1'";
		...
		<div class="rol">
			<table width="" border="0" cellpadding="1" cellspacing="1">
				<tr>
					...
					<th bgcolor="#53F440" scope="col">No Item</th>
					<th bgcolor="#53F440" scope="col">No Warna</th>
					<th bgcolor="#53F440" scope="col">Warna</th>
					<th bgcolor="#53F440" scope="col">Lebar</th>
					<th bgcolor="#53F440" scope="col">Gramasi</th>
				...
				<?php
				//tambahan
				$data = sqlsrv_query($con, "SELECT a.*,b.no_order,b.no_po,b.pelanggan,b.no_lot,b.warna,b.no_item,b.no_warna,b.lebar,b.berat FROM db_qc.tmp_detail_pergerakan_stok a
...
INNER JOIN db_qc.tbl_kite b ON c.id_kite = b.id WHERE a.transtatus='2' and a.userid='" . $usernm . "' order by a.no_roll ASC");
				...
				while ($rowd = sqlsrv_fetch_array($data)) { ?>
					...
					<tr bgcolor="<?php echo $bgcolor; ?>">
						...
						<td align="center"><?PHP echo $rowd['berat']; ?></td>
