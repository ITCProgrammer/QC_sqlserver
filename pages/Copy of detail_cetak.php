...
$Data .="| ".str_pad($row['no_roll'],4,"____",STR_PAD_LEFT)." | ".str_pad(number_format($row['bruto'],'2','.',','),10,"______",STR_PAD_LEFT)." | ".str_pad(number_format($row['yard_'],'2','.',','),10,"______",STR_PAD_LEFT)." | \n"; 
}
//echo $Data;
fwrite($handle, $Data);
fclose($handle);
