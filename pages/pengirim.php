...
function ganti(){     
	...
	{ window.location.href="index1.php?p=pengirim-lain"; }
}
</script> 
</head>
...
<body>
<br />
<form id="form1" name="form1" method="post" action="?p=lihat_data_pengiriman">
  <table width="767">
    <tr>
    ...
    <tr>
      <td>No Order</td>
      <td>:</td>
      <td colspan="3"><label for="no_order"></label>
      <input type="text" name="no_order" id="no_order" /></td>
    </tr>
    <tr>
      <td>No PO</td>
      <td>:</td>
      <td colspan="3"><label for="no_po"></label>
      <input type="text" name="no_po" id="no_po" /></td>
    </tr>
    <tr>
