...
sisa,mutasi_kain.kategori_bs,mutasi_kain.p_jawab,mutasi_kain.masalah_bs,mutasi_kain.no_waste,mutasi_kain.ket_bs,mutasi_kain.tempat_bs
...
$rowket=sqlsrv_fetch_array($sqlket);
    ...
    <td align="center"><?php echo $row['kategori_bs'];?></td>
    <td align="center"><?php echo $row['p_jawab'];?></td>
    <td align="center"><?php echo $row['masalah_bs'];?></td>
    <td>
  <?php echo substr($row['nokk'],0,7)." ".substr($row['nokk'],7,20);?>  
    </td>
    <td><?php echo $row['tempat_bs'];?></td>
    <td><?php echo $row['no_waste'];?></td>
    <td><?php echo $row['ket_bs'];?></td>
  </tr>
