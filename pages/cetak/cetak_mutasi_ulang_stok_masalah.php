...
<html>
  ...
  <head>
    <title>:: Cetak MUTASI KAIN JADI STOK BERMASALAH</title>
...
GROUP BY no_mutasi");
 ...
 echo $rsift;?>
     ...
     echo "Yard / Meter";
        ...
        <td rowspan="3" bgcolor="#F5F5F5">Masalah</td>
...
GROUP BY ket_c");
      ...
      if ($row['sisa']=="SISA" || $row['sisa']=="FKSI") {
        ...
        <td><textarea name="nama6" cols="13" rows="3" placeholder="Ketik disini"></textarea></td>
        <td>&nbsp;</td>
        <td>
          <font size="-2">
