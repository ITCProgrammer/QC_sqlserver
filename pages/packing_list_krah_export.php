...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><label for="select"></label>
      <select name="lprn" onchange="ganti()" >
        ...
        <option value="KRAH-EXPORT" selected="selected">Krah-Manset-EXPORT</option>
  ...
  <tr>
    ...
    <td width="33%"><select name="nopo"  onchange="window.location='index1.php?p=packing_list_krah&amp;dono=<?php echo $_GET['dono'];?>&amp;nopo='+this.value" tabindex="3">
      ...
      <?php $sqlnopo=mysql_query("SELECT trim(no_po) as no_po
FROM `tbl_kite`
WHERE `tbl_kite`.`no_order` = '$_GET[dono]'
GROUP BY no_po");
while($rp=mysql_fetch_array($sqlnopo)){?>
      <option><?php echo $rp['no_po'];?></option>
      <?php  } ?>
      <option value="<?php echo $_GET['nopo'];?>" selected="selected" ><?php echo $_GET['nopo'];?></option>
    </select></td>
    <td width="12%">&nbsp;</td>
    <td width="1%">&nbsp;</td>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="4"><select name="nokk"  onchange="window.location='index1.php?p=packing_list_krah&dono=<?php echo $_GET['dono'];?>&nokk='+this.value" tabindex="4">
      <option value="">PILIH</option>
      <?php 
...
$rowkk1=mysql_fetch_array($snkk1);
	  $sqlnokk=mysql_query("SELECT nokk
FROM `tbl_kite` where `tbl_kite`.no_order='$_GET[dono]' group by nokk");
while($rk=mysql_fetch_array($sqlnokk)){?>
      <option><?php echo $rk['nokk'];?></option>
      <?php  } ?>
      <option value="<?php echo $_GET['nokk'];?>" selected="selected" ><?php echo $_GET['nokk'];?></option>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="4"><select name="nokk2"  onchange="window.location='index1.php?p=packing_list_krah&dono=<?php echo $_GET['dono'];?>&nokk=<?php echo $_GET['nokk'];?>&nokk2='+this.value" tabindex="4">
      <option value="">PILIH</option>
      <?php 
	  $snkk2=mysql_query("SELECT
	count(detail_pergerakan_stok.weight) AS roll,
	sum(detail_pergerakan_stok.weight) AS berat,
	sum(detail_pergerakan_stok.yard_) AS yard
FROM
...
AND detail_pergerakan_stok.sisa != 'FKTH'
AND detail_pergerakan_stok.sisa != 'TH'");
$rowkk2=mysql_fetch_array($snkk2);
	  $sqlnokk=mysql_query("SELECT nokk
FROM `tbl_kite` where `tbl_kite`.no_order='$_GET[dono]' group by nokk");
while($rk=mysql_fetch_array($sqlnokk)){?>
      <option><?php echo $rk['nokk'];?></option>
      <?php  } ?>
      <option value="<?php echo $_GET['nokk2'];?>" selected="selected" ><?php echo $_GET['nokk2'];?></option>
    </select>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="4"><select name="nokk3"  onchange="window.location='index1.php?p=packing_list_krah&dono=<?php echo $_GET['dono'];?>&nokk=<?php echo $_GET['nokk'];?>&nokk2=<?php echo $_GET['nokk2'];?>&nokk3='+this.value" tabindex="4">
      <option value="">PILIH</option>
      <?php 
	  $snkk3=mysql_query("SELECT
	count(detail_pergerakan_stok.weight) AS roll,
	sum(detail_pergerakan_stok.weight) AS berat,
	sum(detail_pergerakan_stok.yard_) AS yard
FROM
...
AND detail_pergerakan_stok.sisa != 'FKTH'
AND detail_pergerakan_stok.sisa != 'TH'");
$rowkk3=mysql_fetch_array($snkk3);
...
while($rk=mysql_fetch_array($sqlnokk)){?>
      <option><?php echo $rk['nokk'];?></option>
      <?php  } ?>
      <option value="<?php echo $_GET['nokk3'];?>" selected="selected" ><?php echo $_GET['nokk3'];?></option>
    </select>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="4"><select name="nokk4"  onchange="window.location='index1.php?p=packing_list_krah&dono=<?php echo $_GET['dono'];?>&nokk=<?php echo $_GET['nokk'];?>&nokk2=<?php echo $_GET['nokk2'];?>&nokk3=<?php echo $_GET['nokk3'];?>&nokk4='+this.value" tabindex="4">
      <option value="">PILIH</option>
      <?php 
	  $snkk4=mysql_query("SELECT
	count(detail_pergerakan_stok.weight) AS roll,
	sum(detail_pergerakan_stok.weight) AS berat,
	sum(detail_pergerakan_stok.yard_) AS yard
FROM
...
AND detail_pergerakan_stok.sisa != 'FKTH'
AND detail_pergerakan_stok.sisa != 'TH'");
$rowkk4=mysql_fetch_array($snkk4);
...
while($rk=mysql_fetch_array($sqlnokk)){?>
      <option><?php echo $rk['nokk'];?></option>
      <?php  } ?>
      <option value="<?php echo $_GET['nokk4'];?>" selected="selected" ><?php echo $_GET['nokk4'];?></option>
    </select>
...
<table width="100%" border="1">
   ...
   if($_GET['dono']!='')
	...
	if($_GET['nokk']!='')
	{ $cwhere.= " AND `tbl_kite`.`nokk`='$_GET[nokk]' "; 
		}else{ $cwhere.= " "; }
	if($_GET['nokk2']!='')
	{ $cwherek2.= " OR `tbl_kite`.`nokk`='$_GET[nokk2]' "; 
		}else{ $cwherek2.= " "; }	
	if($_GET['nokk3']!='')
	{ $cwherek3.= " OR `tbl_kite`.`nokk`='$_GET[nokk3]' "; 
		}else{ $cwherek3.= " "; }	
	if($_GET['nokk4']!='')
	{ $cwherek4.= " OR `tbl_kite`.`nokk`='$_GET[nokk4]' ";}else{ $cwherek4.= " "; }				
if($_GET['nopo']!='')
