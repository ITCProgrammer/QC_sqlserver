...
<body>
    <div id="art-main">
      <input type="button" class="art-button" onClick="window.location.href='../index_login.php?act=logout'" value="Logout"/>
                            <?php if($_SESSION['status']==0){ ?><input type="button" class="art-button" onClick="window.location.href='../index1.php'" value="Home"/><input type="button" class="art-button" onClick="window.location.href='../index1.php?p=laporan_harian_online_produksi'" value="Laporan"/><br /><?php } ?>
...
where stockmovement.wid=22 and stockmovement.transactiontype=4 and stockmovement.transactionstatus=1 and productprop.productiondate between '$tgl_cetak1 07:00:00' and '$tgl_cetak2 07:00:00' and stockmovementdetails.refno like '%extra%' and productprop.BatchNo='$row[batchno]'");
  ...
  <tr bgcolor="#99FFFF">
    ...
    <a href="cetak_data_online_produksi.php?tgl1=<?php echo $tgl_cetak1; ?>&tgl2=<?php echo $tgl_cetak2; ?>&user_name=<?php echo $_POST['user_name']; ?>&sift=<?php echo $_POST['sift']; ?>">Cetak</a>                        
