...
<table width="100%" border="1">
  <tr bgcolor="#3399CC">
    ...
    <td align="center" bgcolor="#FFFFFF">NO SJ</td>
    <td align="center" bgcolor="#FFFFFF">WARNA</td>
    <td align="center" bgcolor="#FFFFFF">ROLL</td>
    <td align="center" bgcolor="#FFFFFF">QUANTITY (KG)</td>
    <td align="center" bgcolor="#FFFFFF">BUYER</td>
    <td align="center" bgcolor="#FFFFFF">NO PO</td>
    <td align="center" bgcolor="#FFFFFF">NO ORDER</td>
    <td align="center" bgcolor="#FFFFFF">JENIS KAIN</td>
    <td align="center" bgcolor="#FFFFFF">LOT</td>
    <td align="center" bgcolor="#FFFFFF">TUJUAN</td>
    <td align="center" bgcolor="#FFFFFF">KET</td>
    <td align="center" bgcolor="#FFFFFF">FOC</td>
  </tr>
  <?php 
  ...
  if($_GET['awal']!=""){
	  $tgll= " tmp_hapus='0' AND tgl_kirim='".$_GET['awal']."' ";
	  }else{$tgll= " tmp_hapus='0' AND tgl_kirim='' ";}	  
  if($_GET['no_sj']!=""){
...
FROM
	tbl_pengiriman
WHERE
	not no_sj='' AND kategori='lain-lain' AND $tgll $sj
ORDER BY no_sj asc");
...
while($row=sqlsrv_fetch_array($sql)){
  ...
  <tr bgcolor="#33CC99">
    ...
    <td colspan="3" align="center" bgcolor="#FFFFFF">ROSDIANTI</td>
    <td colspan="5" align="center" bgcolor="#FFFFFF">PUTRI</td>
  </tr>
  <tr bgcolor="#33CC99">
    ...
    <td colspan="5" align="center" bgcolor="#FFFFFF">PPC AST. MANAGER</td>
  </tr>
  <tr bgcolor="#33CC99">
