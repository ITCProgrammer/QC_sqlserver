...
if(isset($_POST['btnTambah'])){
		...
		$cekSql ="SELECT * FROM tmp_detail_pergerakan_stok WHERE SN='$Barcode' AND refno='$NoList' AND transtatus='2' AND userid='".$usernm."'";
		$cekQry = mysql_query($cekSql) or die ("Gagal Query".mysql_error());
		$cekSql1 ="SELECT * FROM detail_pergerakan_stok WHERE SN='$Barcode' AND refno='$NoList' AND (transtatus='1' or transtatus='0')";
		...
		$cekSql3 ="SELECT * FROM detail_pergerakan_stok WHERE SN='$Barcode' AND refno='$NoList1' AND transtatus='1'";
		...
		//	}
			...
			$pesanError[] = "<b>Data BARCODE $Barcode $ck[sn] $ck[refno] <font color='#FF0000'>TIDAK TERDAFTAR DI PACKING LIST $NoList1</font> </b> ! $ck";
			}	
			...
			$mySql ="SELECT * FROM detail_pergerakan_stok WHERE SN='$Barcode' AND refno='$NoList1' AND transtatus='1'";
			...
			if ($myQty >= 1) {
				...
				(id_detail_kj,weight,yard_,no_roll,grade,satuan,sisa,refno,SN,ket,nokk,ket_c,transtatus,userid)
							VALUES ('$myRow[id_detail_kj]','$myRow[weight]','$myRow[yard_]','$myRow[no_roll]'
							, '$myRow[grade]', '$myRow[satuan]', '$myRow[sisa]', '$myRow[refno]', '$myRow[SN]', '$myRow[ket]', '$myRow[nokk]', '$ketc','2','".$usernm."')";
...
<fieldset>
  ...
  <tr>
    <td>No List</td>
    <td>:</td>
    <td><input type="text" name="listno" id="listno" value="<?php echo $NoList1; ?>" required/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
