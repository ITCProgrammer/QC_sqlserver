...
<div id="art-page-background-simple-gradient">
      ...
      <div class="art-Sheet-tl"></div>
            ...
            <div class="art-Sheet-cc"></div>
                     ...
                     <input type="button" class="art-button" onClick="window.location.href='login.QC-PACKING?act=logout'" value="Logout"/>
                            <?php if($_SESSION['status']==0){ ?><input type="button" class="art-button" onClick="window.location.href='form-Packing'" value="Home"/><input type="button" class="art-button" onClick="window.location.href='form-Packing?p=laporan_harian'" value="Laporan"/><br /><?php } ?>
  ...
  <tr>
   <?php $tgl_cetak1= trim($_POST['thn1']."-".$_POST['bln1']."-".$_POST['tgl1']);
    ...
    <td colspan="21"><b>Tanggal : <?php echo  date("d-M-Y", strtotime($tgl_cetak1))." s/d ".date("d-M-Y", strtotime($tgl_cetak2)); ?> <br>GROUP SHIFT: <?php echo $_POST['user_name']; ?> <br> SHIFT : <?php echo $_POST['sift'];?></b></td>
  </tr>
  <tr align="center" bgcolor="#0099FF">
    <td width="10" rowspan="2">No MC</td>
...
ORDER BY tbl_kite.id ASC");}
  ...
  <tr bgcolor="#99FFFF">
    ...
    <td>&nbsp;</td>
       ...
       <a href="cetak-laporan?tgl1=<?php echo $tgl_cetak1; ?>&tgl2=<?php echo $tgl_cetak2; ?>&user_name=<?php echo $_POST['user_name']; ?>&sift=<?php echo $_POST['sift']; ?>" >Cetak Ke Excel</a>                          
