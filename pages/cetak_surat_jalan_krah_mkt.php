...
<?php
	...
	?> 
<?php
if($_GET['tgl_buat']!=""){$tglbuat=" and tgl_update='$_GET[tgl_buat]' ";}else{$tglbuat=" and DATE_FORMAT(tgl_update,'%y')=DATE_FORMAT(NOW(),'%y')";}
...
WHERE  `packing_list`.`no_sj`='$_GET[no_sj]' ".$tglbuat."
...
GROUP BY detail_pergerakan_stok.nokk,ukuran LIMIT $a,4 "; 
	...
	$c=0;
	 while($rowd=mysqli_fetch_array($data)){
         ...
         $sqlPR=mysqli_query($con,"SELECT * FROM tbl_pengiriman WHERE tgl_buat='$_GET[tgl_buat]' AND no_sj='$_GET[no_sj]'");
...
$rjns=sqlsrv_fetch_array($sqljns);
 ...
 ?>
    ...
    <td><div align="left"><b><font size="+1"><?php echo $rowd['_netto_'];?> PCS</font>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font  size="-1"><?php if($rowPR['price']!="" OR $rowPR['price']!=NULL){echo $rowPR['currency']." ".$rowPR['price'];}else{echo "0";}?></font></b></div></td>
  </tr>
...
<?php if($rt>1){?>
<p><a href="cetak_surat_jalan_krah.php?a=4&no_sj=<?php echo $_GET['no_sj'];?>&tgl_buat=<?php echo $_GET['tgl_buat'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>2){?>
<p><a href="cetak_surat_jalan_krah.php?a=8&no_sj=<?php echo $_GET['no_sj'];?>&tgl_buat=<?php echo $_GET['tgl_buat'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>3){?>
<p><a href="cetak_surat_jalan_krah.php?a=12&no_sj=<?php echo $_GET['no_sj'];?>&tgl_buat=<?php echo $_GET['tgl_buat'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>4){?>
<p><a href="cetak_surat_jalan_krah.php?a=16&no_sj=<?php echo $_GET['no_sj'];?>&tgl_buat=<?php echo $_GET['tgl_buat'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>5){?>
<p><a href="cetak_surat_jalan_krah.php?a=20&no_sj=<?php echo $_GET['no_sj'];?>&tgl_buat=<?php echo $_GET['tgl_buat'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
<?php if($rt>6){?>
<p><a href="cetak_surat_jalan_krah.php?a=24&no_sj=<?php echo $_GET['no_sj'];?>&tgl_buat=<?php echo $_GET['tgl_buat'];?>" target="_blank"><img src="btn_print.png" width="20" height="22" id="nocetak" /></a></p>
<?php }?>
</body>
</html>
<script>
