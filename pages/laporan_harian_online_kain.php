...
<form name="form2">
    ...
    <br />  
<form id="form1" name="form1" method="post" action="pages/lihat_data_online_kain_jadi.php">
  <table width="517">
    <tr>
      <td colspan="3"><div align="center">LAPORAN HARIAN KAIN JADI ONLINE</div> <?php 
